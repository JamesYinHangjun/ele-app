<template>
    <div class="shopcart">
                    ...
                    <div class="entityList-cartbodyScroller">
                        <ul class="entityList-cartlist">
                            <li class="entityList-entityrow" v-for="(food,index) in selectFoods" :key="index">
                                ...
                                {{food.activity.fixed_price}}</span>
        ...
        <!-- :class="{'bottomNav-carticon-empty': isEmpty}" 当购物车为空时，显示的样式 -->
        <div class="bottomNav-cartfooter" :class="{'bottomNav-carticon-empty': isEmpty}">
            ...
            <div class="bottomNav-cartInfo" @click="showCartView=!showCartView">
                ...
                <p class="bottomNav-cartdelivery">另需配送费{{shopInfo.rst.float_delivery_fee}}</p>
            </div>
...
export default {
    ...
    data() {
        return {
            totalCount: 0,        // 用来记录购物车上总共的个数
            totalPrice: 0,
            selectFoods: [],       // 在购物车中存放 各个 food
            showCartView: false    // 控制蒙版的存在与否
        }
    },
    props: {
        shopInfo: Object
