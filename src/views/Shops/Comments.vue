<template>
<div class="comment" v-if="evalution">
    <!-- 商家评分 -->
    <section class="rating-wrap">
        <div class="rating-info">
            <h4>{{evalution.rating.shop_score.toFixed(1)}}</h4>
            <div class="shop-score">
                <span>商家评分</span>
                <Rating :rating="evalution.rating.shop_score" />
            </div>
        </div>
        ...
        <div class="other-score">
            <div class="tp-score">
                <div>
                    <span>味道</span>
                    <p>{{evalution.rating.taste_score.toFixed(1)}}</p>
                </div>
                <div>
                    <span>包装</span>
                    <p>{{evalution.rating.package_score.toFixed(1)}}</p>
                </div>
            </div>
            ...
            <div class="rider-score">
                <span>配送</span>
                <p>{{evalution.rating.rider_score.toFixed(1)}}</p>
            </div>
        </div>
    </section>
    ...
    <div class="shop-info">
        <!-- 标签 -->
        <ul class="tags">
            <li :class="{'unsatisfied': item.unsatisfied}" v-for="(item,index) in evalution.tags" :key="index">
                {{item.name}}
